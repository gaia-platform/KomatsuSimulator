...
namespace Sensors.Rendering
{
    //*********************************************************************
    /// <summary>
    /// Tries to match the official API. 
    /// See https://github.com/Alabate/AsyncGPUReadbackPlugin 
    /// </summary>
    //*********************************************************************
    public class SensorAsyncGPUReadbackPlugin
    {
        public static SensorAsyncGPUReadbackPluginRequest Request(Texture src)
        {
            return new SensorAsyncGPUReadbackPluginRequest(src);
        }
    }
    ...
    /// </summary>
    //*********************************************************************
    public class SensorAsyncGPUReadbackPluginRequest
    {
        ...
        /// <returns></returns>
        //*********************************************************************
        public SensorAsyncGPUReadbackPluginRequest(Texture src)
        {
